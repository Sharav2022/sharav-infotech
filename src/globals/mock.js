...
export const TESTIMONIALS = [
  {
    id: 1,
    testimony:
      "I can't express how grateful I am to have partnered with Sharav Infotech for our company's technology needs. From the moment we engaged with their team, we've experienced nothing short of exceptional service and expertise.",
    name: "Anshu Garg",
  },
  {
    id: 2,
    testimony:
      "One of the standout features of our collaboration has been their responsiveness. Whether it's a minor issue or a critical emergency, Sharav Infotech has consistently been there to provide support. Their technicians are not only highly skilled but also excellent communicators, making complex tech jargon easy to understand for someone like me, who isn't tech-savvy.",
    name: "Kiel Paul",
  },
  {
    id: 3,
    testimony:
      "I can confidently say that Sharav Infotech has been an invaluable partner in our journey towards IT excellence. Their dedication, expertise, and unwavering commitment to our success are commendable. I wholeheartedly recommend them to any business seeking top-notch IT solutions and support.",
    name: "Chris Howard",
  },
];
